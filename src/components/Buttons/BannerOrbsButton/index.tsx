...
const BannerOrbsButton = ({
  ...
  return (
    <Link href={link}>
      ...
      >
        <div
          className={`absolute ${height} ${width} bg-primary-500 rounded-full opacity-50 z-20`}
        />
        <div className={`h-full w-full z-10 flex items-center justify-center text-center`}>
          <p className={`z-20 font-bold text-xl text-white ${isHovered && 'scale-110'}`}>
