  ...
  const services = [
    {
      ...
      description:
        'Experiência interativa completa onde o usuário navega por ambientes digitais com visão panorâmica total.',
      longDescription:
        'Navegue livremente por todos os cômodos e espaços do projeto com controle total da câmera. Visualize cada detalhe, textura e acabamento como se estivesse fisicamente presente no local.',
    ...
    },
    {
      ...
      description:
        'Tecnologia VR com óculos que cria ambientes digitais totalmente imersivos e realistas.',
      longDescription:
        'Mergulhe completamente no projeto usando óculos VR de última geração. Sinta-se verdadeiramente dentro do ambiente com experiência imersiva total.',
    ...
    },
    {
      ...
      description:
        'Representação gráfica realista com acabamentos, móveis, decoração e cores autênticas.',
      longDescription:
        'Visualize a planta baixa em três dimensões com todos os móveis, decoração e acabamentos posicionados de forma realista e proporcional.',
    ...
    },
    {
      ...
      title: 'IMAGEM 3D',
      description:
        'Representação visual tridimensional que simula profundidade, volume e perspectiva realista.',
      longDescription:
        'Renderizações fotorrealistas em alta resolução que capturam cada detalhe do projeto com iluminação natural e materiais autênticos.',
    ...
    },
    {
      ...
      longDescription:
        'Vídeos cinematográficos que conduzem o espectador através de todos os ambientes do projeto com transições suaves e ângulos estratégicos.',
    ...
    },
    {
      ...
      description:
        'Tecnologia que digitaliza ambientes reais em alta precisão criando modelos virtuais completos.',
      longDescription:
        'Captura digital precisa de ambientes existentes usando tecnologia de escaneamento 3D para criar réplicas virtuais exatas.',
                        ...
                        <div className="flex items-center space-x-4 mb-6">
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-1 mt-1">
                              ...
                              <span className="text-sm text-gray-500">Tecnologia Premium</span>
                            </div>
                          </div>
                        </div>
